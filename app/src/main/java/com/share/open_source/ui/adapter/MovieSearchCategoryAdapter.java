...
public class MovieSearchCategoryAdapter extends BaseQuickAdapter<ProgramModel,BaseViewHolder> {
    ...
    public MovieSearchCategoryAdapter(Context mContext, List<ProgramModel> list){
        super(list);
        ...
        getMultiTypeDelegate()
                .registerItemType(MOVIE, R.layout.module_movie_search_list_item)
